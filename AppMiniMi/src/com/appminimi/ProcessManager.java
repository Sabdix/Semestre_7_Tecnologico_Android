...
public class ProcessManager extends ListActivity {
	...
	protected void onListItemClick(ListView parent, View view, int position, long id) {
		...
		CharSequence[] options = {"Detalles", "Lanzar"};
		final int index = position;
		
		builder.setTitle("Opciones de Procesos");
				...
				switch (choice) {				
					...
					case 1:
						...
						if(i != null)
							...
							Toast.makeText(ProcessManager.this, "Fallo lanzar", Toast.LENGTH_SHORT).show();	
	...
	private void update_labels() {
		...
		availMem_label.setText(String.format("Memoria disponible:\t %.2f Mb", mem_size));
		numProc_label.setText("Numero de procesos:\t " + display_process.size());
	}
