...
public class DirectoryInfo extends Activity {
	...
	private class BackgroundWork extends AsyncTask<String, Void, Long> {
		...
		protected void onPreExecute(){
			dialog = ProgressDialog.show(DirectoryInfo.this, "", "Calculando Información...", true, true);
		}
		...
		protected void onPostExecute(Long result) {
			...
			mDirLabel.setText(mDirCount + " carpetas ");
			mFileLabel.setText(mFileCount + " archivos ");
