...
public class WirelessManager extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String[] labels = {"Señal", "Estado del WIFI", "ip address",
	...
	private void get_wifi() {
		...
		enable_label.setText(enabled ?"WiFi Habilitado" :"WiFi deshabilitado");
		state_button.setText(enabled ?"Deshabilitar wifi" : "Prender wifi");
		
		switch(state) {
			case WifiManager.WIFI_STATE_ENABLED:
				data_labels[WIFISTATE].setText(" Habilitado");
				break;
			case WifiManager.WIFI_STATE_DISABLED:
				data_labels[WIFISTATE].setText(" Deshabilitado");
				break;
			case WifiManager.WIFI_STATE_DISABLING:
				data_labels[WIFISTATE].setText(" Siendo apagado");
				break;
			case WifiManager.WIFI_STATE_ENABLING:
				data_labels[WIFISTATE].setText(" Siendo prendido");
				break;
			case WifiManager.WIFI_STATE_UNKNOWN:
				data_labels[WIFISTATE].setText(" S/I");
				break;
		}
		if(enabled) {
			...
			data_labels[SSTRENGTH].setText("potencia " + strength);
		}else {
		...
		public void onClick(View v) {
			...
			if(v.getId() == R.id.back_button) {
				if(wifi.isWifiEnabled()){
					...
					state_button.setText("Habilitar wifi");
				}else {
					wifi.setWifiEnabled(true);
					state_button.setText("Deshabilitar wifi");
					get_wifi();
				}	
