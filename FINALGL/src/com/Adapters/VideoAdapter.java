...
public class VideoAdapter extends ArrayAdapter<Video> implements SectionIndexer {
    ...
    public VideoAdapter(Context context, ArrayList<Video> itemsArrayList,ContentResolver resolver,Resources resource) {
        ...
        super(context, R.layout.renglon_video, itemsArrayList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            vi.inflate(R.layout.renglon_video, alertView, true);
        }
        else
        {
        ...
        TextView labelView = (TextView) alertView.findViewById(R.id.tvTituloVideo);
